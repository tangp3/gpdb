...
class GpRecoverSegmentProgramTestCase(unittest.TestCase):
    ...
    def test_check_segment_state_with_segment_in_change_tracking_disabled(self, mock_results):
        options = Mock()
        ...
        segmentStates = gprecover_prog.check_segment_state(segmentList, dbsMap)
