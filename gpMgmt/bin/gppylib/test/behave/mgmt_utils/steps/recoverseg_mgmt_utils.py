...
@given('wait until the segment state of the pair primary goes in ChangeTrackingDisabled')
@when('wait until the segment state of the pair primary goes in ChangeTrackingDisabled')
@then('wait until the segment state of the pair primary goes in ChangeTrackingDisabled')
def impl(context):
...
@given('the information of pair primary segment on a remote host is saved')
@when('the information of pair primary segment on a remote host is saved')
@then('the information of pair primary segment on a remote host is saved')
def impl(context):
    gparray = GpArray.initFromCatalog(dbconn.DbURL())
